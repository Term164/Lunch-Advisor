...
var connectionString = builder.Configuration.GetConnectionString("LunchAdvisorContextConnection") ?? throw new InvalidOperationException("Connection string 'LunchAdvisorContextConnection' not found.");
